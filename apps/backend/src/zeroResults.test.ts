...
test('formatRunResult maps legacy 9999 timeout time to dash placeholder for 1 km / 5 km', () => {
  assert.equal(formatRunResult(1, 9999, 1000), '--:--');
  assert.equal(formatRunResult(2, 9999, 5000), '--:--');
  assert.equal(formatRunResult(1, '9999', 1000), '--:--');
});

test('formatRunResult maps legacy 166:39 display time to dash placeholder for 1 km / 5 km', () => {
  assert.equal(formatRunResult(1, '166:39', 1000), '--:--');
  assert.equal(formatRunResult(2, '166:39', 5000), '--:--');
});
