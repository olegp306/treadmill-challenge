...
const FAQ = [
  ...
  { q: 'Можно ли улучшить результат?', a: 'Можно принимать участие не ограниченное количество раз' },
  {
    q: 'Когда обновляется рейтинг?',
    a: 'Рейтинг на сайте обновляется раз в 30 минут, в магазине рейтинг обновляется мгновенно',
  },
  {
    q: 'Сколько всего победителей?',
    a: 'Всего 6 победителей в каждой дисциплине, по одному на каждый режим забега в мужском и женском зачете',
  },
];
          ...
          >
            ...
            <div className="leaderboard2__joinContent">
              ...
              <div className="leaderboard2__joinTitle">
                <span className="leaderboard2__joinTitleLine">
                  <span>в ТЦ «Авиапарк»<span className="leaderboard2__joinTitleComma">,</span></span>
                  {' '}
